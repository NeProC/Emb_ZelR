...
int main()
{
    ...
    int32_t len_new_arr = second_zero_quantity(arr, len_arr); 
    int32_t new_arr[len_new_arr];
    second_zero_quantity_new_arr(arr, new_arr, len_arr);
    print_arr(new_arr, len_new_arr);
    return 0;
}
